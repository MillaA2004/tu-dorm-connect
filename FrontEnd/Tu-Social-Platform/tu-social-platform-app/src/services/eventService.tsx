...
export const eventService = {
  ...
  getEventsUserParticipatesIn: async (
    userId: number
  ): Promise<EventItem[]> => {
    const res = await apiClient.get<EventResponseDTO[]>(
      `${EVENTS_BASE}/participant/${userId}`
    );
    return res.data.map(mapDtoToEventItem);
  },
  ...
  createEvent: async (
    ...
    const res = await apiClient.post<EventResponseDTO>(
      `${EVENTS_BASE}/creator/${creatorId}`,
      payload
    );
    return mapDtoToEventItem(res.data);
  },
  ...
  updateEvent: async (
    ...
    const res = await apiClient.put<EventResponseDTO>(
      `${EVENTS_BASE}/${eventId}/creator/${creatorId}`,
      payload
    );
    return mapDtoToEventItem(res.data);
  },
  ...
  deleteEvent: async (eventId: number, userId: number): Promise<void> => {
    await apiClient.delete(`${EVENTS_BASE}/${eventId}/creator/${userId}`);
  },
  ...
  joinEvent: async (
    ...
    const res = await apiClient.post<EventResponseDTO>(
      `${EVENTS_BASE}/${eventId}/join/${userId}`
    );
    return mapDtoToEventItem(res.data);
  },
  ...
  leaveEvent: async (
    ...
    const res = await apiClient.post<EventResponseDTO>(
      `${EVENTS_BASE}/${eventId}/leave/${userId}`
    );
    return mapDtoToEventItem(res.data);
  },
...
removeParticipant: async (
  ...
  const res = await apiClient.delete<EventResponseDTO>(
    `${EVENTS_BASE}/${eventId}/participants/${participantId}/creator/${creatorId}`
  );
  return mapDtoToEventItem(res.data);
},
