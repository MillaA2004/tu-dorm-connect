...
public class MatchingService {
    public double calculateMatchScore(Questionnaire q1, Questionnaire q2) {
        ...
        // Boolean comparisons
        score += match(q1.getSmokes(), q2.getSmokes()); total++;
        score += match(q1.getDrinks(), q2.getDrinks()); total++;
        score += match(q1.getPartyHome(), q2.getPartyHome()); total++;
        ...
        score += match(q1.getCooksInDorm(), q2.getCooksInDorm()); total++;
        ...
        score += scaleMatch(q1.getCleanliness(), q2.getCleanliness()); total++;
        score += scaleMatch(q1.getBedtime(), q2.getBedtime()); total++;
        score += scaleMatch(q1.getNeedsQuiet(), q2.getNeedsQuiet()); total++;
        score += scaleMatch(q1.getGuestFrequency(), q2.getGuestFrequency()); total++;
        ...
        score += scaleMatch(q1.getPersonalSpaceImportance(), q2.getPersonalSpaceImportance()); total++;
    ...
    private double match(Boolean a, Boolean b) {
        return (a != null && b != null && a.equals(b)) ? 1.0 : 0.0;
    }
    ...
    private double stringMatch(String a, String b) {
        return (a != null && b != null && a.equalsIgnoreCase(b)) ? 1.0 : 0.0;
    }
}
